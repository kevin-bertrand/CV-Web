...
curl_setopt($curl, CURLOPT_URL, "http://localhost:8080/project");
            ...
            foreach(array_reverse($projects) as $project) {
                ...
                <div class="row justify-content-between project-view align-items-center">
                    <div class="col-md-6 project_image">
                        <img src=<?= "public/img/" . $project["mediaPath"] ?> onclick=<?= "showModal('public/img/" . $project["mediaPath"] . "','" . $project["title"] . "')" ?> />
                    </div>
